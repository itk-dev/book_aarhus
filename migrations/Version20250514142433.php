 ...
 */
final class Version20250514142433 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE holiday_opening_hours (id INT AUTO_INCREMENT NOT NULL, resource_id INT NOT NULL, holiday_open DATETIME NOT NULL, holiday_close DATETIME NOT NULL, source_id INT NOT NULL, UNIQUE INDEX UNIQ_7F8827F8953C1C61 (source_id), INDEX IDX_7F8827F889329D25 (resource_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
