 ...
 */
final class Version20250430092911 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE location_type (id INT AUTO_INCREMENT NOT NULL, resource_id INT NOT NULL, location_type VARCHAR(512) NOT NULL, update_timestamp DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
