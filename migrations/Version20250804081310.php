 ...
 */
final class Version20250804081310 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE opening_hours (id INT AUTO_INCREMENT NOT NULL, resource_id INT NOT NULL, weekday INT NOT NULL, open DATETIME NOT NULL, close DATETIME NOT NULL, source_id INT NOT NULL, UNIQUE INDEX UNIQ_2640C10B953C1C61 (source_id), INDEX IDX_2640C10B89329D25 (resource_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
